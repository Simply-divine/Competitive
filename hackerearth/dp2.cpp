...
void multiply(ll F[2][2],ll M[2][2],ll mod){
	ll x = add(mul(F[0][0],M[0][0],mod),mul(F[0][1],M[1][0],mod),mod);
 	ll y =add( mul(F[0][0],M[0][1],mod),mul( F[0][1],M[1][1],mod),mod);
	ll z =add( mul(F[1][0],M[0][0],mod),mul(F[1][1],M[1][0],mod),mod);
 	ll w =add( mul(F[1][0],M[0][1],mod),mul( F[1][1],M[1][1],mod),mod);
