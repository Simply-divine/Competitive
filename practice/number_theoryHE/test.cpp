...
int main()
{
	...
	int n = randomNoGenerator(100)%(2*100001);
	cout<<n<<nl;
	rep(i,0,n-1){
		cout<<(randomNoGenerator(100)%(2*100001))<<" ";
	}
	cout<<nl;
	int t = randomNoGenerator(100)%(2*100001);
	cout<<t<<nl;
	while(t-->0){
		int p = randomNoGenerator(100)%(2*100001);
		int q = randomNoGenerator(100)%(2*100001);
		cout<<p<<" "<<q;
	}
	cout<<nl;
	return 0;
