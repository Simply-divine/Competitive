...
int main()
{
	...
	init_segment_tree(7); (build_segment_tree(RANGE_MAX,A,1,0,6));
	int B[] = {10,2,47,3,7,9,1,98,21,37};
	init_segment_tree(10);
	build_segment_tree(RANGE_MAX,B,1,0,9);
	printf("%d\n",query(RANGE_MAX,B,1,0,9,1,7));
	printf("%d\n",query(RANGE_MAX,B,1,0,9,3,8));
	printf("%d\n",query(RANGE_MAX,A,1,0,6,1,3));
	build_segment_tree(RANGE_SUM,B,1,0,9);
	printf("%d\n",query(RANGE_SUM,B,1,0,9,1,3));
	printf("%d\n",query(RANGE_SUM,B,1,0,9,1,7));
	return 0;
}
